...
i = int(input('Digite 1 para Subscrever e 2 para Chat: '))
...
if i == 1:
        ...
        me = str(input('Digite seu nome como no registro: ')) # User's name (as registered in the registry. E.g., Alice, Bob, ...)
